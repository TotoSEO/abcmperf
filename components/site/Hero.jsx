    ...
    <section className="hero on-dark" data-theme="dark">
      ...
      <div className="container hero__inner">
        ...
        <p className="hero__lead">
          ABCM Performances est une agence de marketing, marketing digital et communication, ainsi qu'un
          organisme de formation certifié Qualiopi basé à Strasbourg. Notre expertise dans le digital et la
          transmission de savoir-faire, forte de plus de 10 ans de pratique auprès d'une riche variété de
          clients, nous permet aujourd'hui de vous accompagner avec qualité et professionnalisme. Gestion de vos
          réseaux sociaux, création de site web, gestion de votre budget Google ADS ou formation en
          référencement naturel, nous disposons des services qu'il faut à votre entreprise pour grandir !
        </p>
