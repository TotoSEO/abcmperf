...
export const ABCM_SERVICES = [
  // ----------------------------------------------------------------- WEB
  {
    ...
    intro: [
      ...
      "Nos sites attirent un trafic qualifié grâce à un [référencement naturel](/referencement-strasbourg/) intégré dès la conception, convertissent vos visiteurs en clients et respectent les dernières normes UX, RGPD et de sécurité.",
      "Vous vendez en ligne ? Nous créons aussi votre [boutique e-commerce](/creation-site-ecommerce/). Et une fois le site livré, nous pouvons en assurer la [maintenance et l'hébergement](/maintenance-site-web/).",
    ],
    features: [
  ...
  },
  {
    ...
    intro: [
      ...
      "Que votre [site internet](/agence-web-strasbourg/) ou votre [boutique e-commerce](/creation-site-ecommerce/) tourne sur WordPress, PrestaShop, Drupal ou Joomla, nous veillons à ce qu'il reste rapide, sûr et à jour.",
    ],
    features: [
  ...
  // -------------------------------------------------------- RÉFÉRENCEMENT
  {
    ...
    intro: [
      ...
      "En amont, nous réalisons toujours un [audit SEO](/audit-referencement/) de votre site et vous remettons une liste de préconisations. La stratégie travaille ensuite votre positionnement sur les requêtes qui concernent réellement votre activité.",
      "Le SEO se pense dès la [création du site](/agence-web-strasbourg/) et se complète très bien avec la [publicité Google Ads](/agence-sea/) pour des résultats à court terme, ou avec le [référencement GEO](/referencement-ia-geo/) pour exister dans les moteurs d'IA.",
    ],
    features: [
  ...
  },
  {
    ...
    intro: [
      ...
      "Le référencement GEO devient essentiel pour exister dans ces réponses et renforcer votre autorité. Nous combinons le [SEO traditionnel](/referencement-strasbourg/) et des leviers avancés (AEO, GSO, GEO) pour positionner votre marque comme une source incontournable.",
    ],
    features: [
  ...
  },
  {
    ...
    intro: [
      "L'audit SEO mesure où en est votre site en termes de performances techniques. Un site mal optimisé ne peut pas bénéficier d'une [stratégie de référencement](/referencement-strasbourg/) efficace : nous proposons donc toujours un audit en amont.",
      "Il met en évidence vos points forts comme les éléments bloquants : positions actuelles, performances techniques, architecture, maillage interne, compatibilité mobile, balisages. Vous repartez avec un rapport et un plan d'action clairs, applicables sur votre [site internet](/agence-web-strasbourg/).",
    ],
    features: [
  ...
  // ----------------------------------------------------------- SOCIAL / VIDÉO
  {
    ...
    intro: [
      ...
      "Cette communication demande du temps et des compétences spécifiques. Nous concevons une stratégie personnalisée et une ligne éditoriale détaillée, alimentée par des [vidéos pensées pour les réseaux](/video-reseaux-sociaux/) qui génèrent de l'engagement.",
  ...
  },
  {
    ...
    intro: [
      ...
      "Nous concevons des packs sur mesure pour Instagram, TikTok, Facebook et les autres plateformes. Ces vidéos prennent tout leur sens lorsqu'elles sont [diffusées et animées](/community-management/) dans une vraie stratégie sociale, et se déclinent aussi en [vidéos de marque employeur](/videos-marque-employeur/).",
    ],
    features: [
  ...
  // ------------------------------------------------------ MARKETING / ACQUISITION
  {
    ...
    intro: [
      "Augmentez les visites de votre site, dopez les ventes de votre [boutique e-commerce](/creation-site-ecommerce/) et gagnez en visibilité grâce à des campagnes SEA performantes sur Google Search, Shopping et le réseau Display.",
      "Là où le [référencement naturel](/referencement-strasbourg/) construit votre visibilité sur le long terme, la publicité en ligne touche les bonnes audiences immédiatement, sur les requêtes qui comptent. Nous pilotons et optimisons vos campagnes au quotidien.",
    ],
    features: [
  ...
  },
  {
    ...
    intro: [
      ...
      "Nous prenons en charge la gestion stratégique et opérationnelle de vos leviers : [référencement](/referencement-strasbourg/), [publicité en ligne](/agence-sea/), [réseaux sociaux](/community-management/). Un regard externe, une vision claire et une proposition de valeur qui vous distingue durablement.",
    ],
    features: [
  ...
  },
  {
    ...
    intro: [
      ...
      "Nous structurons une identité professionnelle forte et cohérente, qui reflète vos valeurs et vous positionne comme une référence. Cette présence se travaille au quotidien sur les [réseaux sociaux](/community-management/) et peut s'appuyer sur des [vidéos de marque employeur](/videos-marque-employeur/).",
    ],
    features: [
